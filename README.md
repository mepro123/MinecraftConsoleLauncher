...
6. **If you download/browse** and it is taking too long to, this might be a problem with [modrinth api](https://status.modrinth.com). Modrinth have issues with search rarely 
